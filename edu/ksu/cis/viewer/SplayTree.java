...
public final class SplayTree implements BSTInterface {
   ...
   * <code>key</code> is already in the tree, a tree having the same contents with 
   * <code>key</code> at the root is returned.
  ...
  /**
   * Returns the Splay Tree that results from the insertion of <code>key</code>
   * into <code>t</code>, which is assumed to be a valid binary search tree.  
   */
  ...
  /**
   * Returns the Splay Tree resulting from the removal of <code>s</code> from 
   * <code>t</code>, which is assumed to be a valid binary search tree.  
   */
   ...
   * child of <code>t</code> with <code>right</code>.
   */
  ...
  /**
   * Returns the <code>BinaryTree</code> resulting from performing a "zig-zig"
   * double rotate left on the tree resulting from replacing the right-hand
   * child of the right-hand child of <code>t</code> with <code>rightRight</code>.
   */
  ...
  /**
   * Returns the <code>BinaryTree</code> resulting from performing a "zig-zag"
   * double rotate left on the tree resulting from replacing the left-hand
   * child of the right-hand child of <code>t</code> with <code>rightLeft</code>.
   */
   ...
   * child of <code>t</code> with <code>left</code>.
   */
   ...
   * child of the left-hand child of <code>t</code> with <code>leftLeft</code>.
   */
   ...
   * child of the left-hand child of <code>t</code> with <code>leftRight</code>.
   */
