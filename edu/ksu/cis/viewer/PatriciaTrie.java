...
public final class PatriciaTrie implements BSTInterface, TreeInterface {
  ...
  /**
   * Returns the <code>PatriciaTrie</code> resulting from the insertion of 
   * <code>key</code> into this <code>PatriciaTrie</code>.  If <code>key</code> is 
   * already in this <code>PatriciaTrie</code>, an identical <code>Trie</code> will 
   * be returned.
   */
  ...
  /**
   * Returns the <code>PatriciaTrie</code> resulting from the removal of 
   * <code>key</code> from this <code>PatriciaTrie</code>.  If <code>key</code> is not 
   * in this <code>PatriciaTrie</code>,
   * an identical <code>PatriciaTrie</code> is returned.
   */
  ...
  /**
   * Returns a drawing of this <code>PatriciaTrie</code>.
   */
  ...
  /**
   * Returns the root of this <code>PatriciaTrie</code>.  This method is intended 
  ...
  /**
   * Returns the children of this <code>PatriciaTrie</code>.  This method is 
   * intended for use by the <code>TreeDrawing</code> class.
   */
  ...
  /**
   * Returns <code>true</code> if this <code>PatriciaTrie</code> is empty.
   * This method is intended for use by the <code>TreeDrawing</code> class.
   */
