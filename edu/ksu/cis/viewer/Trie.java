 ...
 * The root of the tree stores <code>null</code>, and its children store the
...
public final class Trie implements BSTInterface, TreeInterface {
  ...
  /**
   * Returns the <code>Trie</code> resulting from the insertion of <code>key</code>
   * into this <code>Trie</code>.  If <code>key</code> is already in this 
   * <code>Trie</code>, an identical <code>Trie</code> will be returned.
   */
  public BSTInterface put(String key) throws NullPointerException {
	...
	t.children[loc].root = new TrieNode(Character.valueOf(c), 
					    key.length() == 1);
  ...
  /**
   * Returns the <code>Trie</code> resulting from the removal of <code>key</code>
   * from this <code>Trie</code>.  If <code>key</code> is not in this <code>Trie</code>,
   * an identical <code>Trie</code> is returned.
   */
  ...
  /**
   * Returns a drawing of this <code>Trie</code>.
   */
  ...
  /**
   * Returns the root of this <code>Trie</code>.  This method is intended for
   * use by the <code>TreeDrawing</code> class.
   */
  ...
  /**
   * Returns the children of this <code>Trie</code>.  This method is intended
   * for use by the <code>TreeDrawing</code> class.
   */
  ...
  /**
   * Always returns <code>false</code>.  This method is intended
   * for use by the <code>TreeDrawing</code> class.
   */
...
class TrieNode implements Serializable {
   ...
   * @param w  <code>true</code> if this node denotes the end of a String.
   */
  ...
  /**
   * Returns <code>true</code> if this node denotes the end of a String.
   */
...
class TrieColorizer implements Colorizer {
   ...
   * is a valid root of a <code>Trie</code> and indicates the end of a String,
