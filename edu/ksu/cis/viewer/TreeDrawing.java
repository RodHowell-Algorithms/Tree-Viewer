 ...
 * draw the tree.
 * <p>
 * There are two general ways of constructing a <code>TreeDrawing</code>.  The
 ...
 * can be 
 * efficiently obtained from the <code>{@link #getDrawing() getDrawing()}</code> 
 * method.  This method 
 * returns a new <code>TreeComponent</code>
 * each time it is called, so they can be used in multiple containers.  These
 * components will all share the same <code>TreeDrawing</code>.
 * <p>
...
public final class TreeDrawing implements Serializable {
   ...
   * <code>String.valueOf(Object)</code> method.
   ...
   * are obtained using the <code>String.valueOf(Object)</code> method.
   * @param  tree      The tree to be drawn.  If <code>null</code>, no tree is
   *                   drawn.
   * @param  maxHeight The maximum height to display.  If this value is
   *                   negative, no nodes will be displayed.
   * @param  col       The Colorizer used to obtain the color of each node.
   *                   If <code>null</code>, each node is colored black.
   * @throws RuntimeException if <code>col</code> throws a RuntimeException on
   *                          any node of <code>tree</code>
   * @see java.lang.String String.valueOf(Object)
   */
   ...
   * @return   the width of this tree in characters
   */
  public int getWidth() {
    return width;
  }
   ...
   * @return    the height of this tree in text lines
   */
  ...
  /**
   * Returns a <code>TreeComponent</code> displaying this drawing using
   * {@link TreeComponent#DEFAULT_FONT TreeComponent.DEFAULT_FONT}.
   * @return     a component containing a drawing using the default font.
   */
  ...
  /**
   * Returns a <code>TreeComponent</code> displaying this drawing using the 
   * given Font.
   * @param      fnt   the font to use
   * @return     a component containing a drawing using the given font
